...
with mlflow.start_run():
    ...
    # Convert sparse matrix to DMatrix for XGBoost
    ...
    params = {
        ...
        'num_class': len(df['grade3'].unique()),  # Number of classes
        'max_depth': 6,
        'eta': 0.3,
    ...
    def classify_review(review_text):
        ...
        dmatrix_representation = xgb.DMatrix(bow_representation)
        prediction = bst.predict(dmatrix_representation)
        return prediction[0]
